...
const ROWS = [
  ...
  { label: 'Powertrain', get: () => null, show: (m) => m.fuel, better: 0 },
  ...
  { label: 'Power', get: (m) => m.hp, show: (m) => `${m.hp} hp`, better: 1 },
  { label: 'Torque', get: (m) => m.torque, show: (m) => `${m.torque} lb-ft`, better: 1 },
  {
    label: '0–60 mph',
    get: (m) => m.zeroToSixty,
    show: (m) => `${m.zeroToSixty.toFixed(1)}s`,
    better: -1,
  },
  { label: 'Top speed', get: (m) => m.topSpeed, show: (m) => `${m.topSpeed} mph`, better: 1 },
  {
    label: 'Battery',
  ...
  { label: 'Doors', get: () => null, show: (m) => m.doors, better: 0 },
  {
    label: 'Luggage',
    get: (m) => m.cargo,
    show: (m) => `${m.cargo} cu ft`,
    better: 1,
  },
  {
    label: 'Length',
    get: () => null,
    show: (m) => `${m.dims.length} in`,
    better: 0,
  },
  {
    label: 'Wheelbase',
    get: () => null,
    show: (m) => `${m.dims.wheelbase} in`,
    better: 0,
  },
  {
    label: 'Kerb weight',
    get: (m) => m.weight,
    show: (m) => `${m.weight.toLocaleString('en-US')} lb`,
    better: -1,
  },
